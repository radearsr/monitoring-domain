...
exports.MESSAGE_REPLY = {
  ...
  DOMAIN_FAILED_RESPONSE: (domain, message) =>
    `[ FAILED ADD DOMAIN 🔴] Gagal menambahkan domain baru\nResponse: ${message}\nMohon Akses Whois\nhttps://www.whois.com/whois/${domain}`,
  ...
  DOMAIN_ADD_SUCCESS: (domain, expired) =>
    `[ SUCCESS ADD DOMAIN 🟢 ]\nDomain ${domain}\nExpired ${expired}`,
  SSL_ADD_SUCCESS: (domain, port, expired) =>
    `[ SUCCESS ADD SSL 🟢 ]\nDomain ${domain}\nPort ${port}\nExpired ${formatDate(
      expired
    )}`,
};
